...
MYSQL_APP = ("trove.guestagent.datastore.mariadb.service."
             "MySqlApp")
MYSQL_APP_STATUS = ("trove.guestagent.datastore.mariadb.service."
                    "MySqlAppStatus")
MYSQL_ADMIN = ("trove.guestagent.datastore.mariadb.service."
               "MySqlAdmin")

...
MYSQL_APP = ("trove.guestagent.datastore.pxc.service."
             "PXCApp")
MYSQL_APP_STATUS = ("trove.guestagent.datastore.pxc.service."
                    "PXCAppStatus")
MYSQL_ADMIN = ("trove.guestagent.datastore.pxc.service."
               "PXCAdmin")
